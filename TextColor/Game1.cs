...
namespace TextColor
{
    ...
    protected override void Draw(GameTime gameTime)
    {
      ...
      // 白文字で描画
      _spriteBatch.DrawString(_font, "The white character",
          new Vector2(60.0f, 50.0f), Color.White);

      // 赤文字で描画
      _spriteBatch.DrawString(_font, "The red character",
          new Vector2(60.0f, 100.0f), Color.Red);

      // 青文字で描画
      _spriteBatch.DrawString(_font, "The blue character",
          new Vector2(60.0f, 150.0f), Color.Blue);

      // 緑文字で描画
      _spriteBatch.DrawString(_font, "The light green character",
